1. create admin index of all users. issue with admin link with future appointments needs to be changed to my appointments. new link for that specifc users appointments in url.
